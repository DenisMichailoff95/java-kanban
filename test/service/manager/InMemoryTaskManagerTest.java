...
class InMemoryTaskManagerTest {
    ...
    @Test
    void getTaskByID() {
        Task task1 = new Task(TaskStatus.NEW, "My subTask1", "com.dam.tasks.Task description", Instant.parse("2025-01-05T12:00:00.000000000Z"),300);
        taskManager.addTask(task1);
        int taskId1 = task1.getTaskId();
        System.out.println(taskId1);
        String taskId = Integer.toString(taskId1);
        String taskParams = "Task{status=NEW, taskName='My subTask1', taskDescription='com.dam.tasks.Task description', taskId=" + taskId + ", startTime=2025-01-05 12:00:00, endTime=2025-01-05 17:00:00, duration=05:00}";
