...
public class InMemoryHistoryManagerTest {
    ...
    void checkRepeatedRequestHistoryTest() {
        HistoryManager historyManager = Managers.getDefaultHistory();
        Task task = new Task(TaskStatus.NEW, "My Task1", "com.dam.tasks.Task description", Instant.parse("2025-01-05T12:00:00.000000000Z"), Duration.ofHours(1));
    ...
    void disappearanceFromHistoryAfterRemoveFromTaskManagerTest() {
        ...
        System.out.println(historyAfter.toString());
        System.out.println(historyBefore.toString());
        String taskParams = "[Task{status=NEW, taskName='My Task1', taskDescription='com.dam.tasks.Task description', taskId=" + taskId + ", startTime=2025-01-05 12:00:00, endTime=2025-01-05 13:00:00, duration=01:00:00}]";
